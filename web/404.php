...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="">
    ...
    <div class="p-5 w-100 d-flex flex-column align-items-center">
      ...
      <button class="mt-2 btn btn-primary"><a class="text-white" href="/Crosswalk Agency/">ไปหน้าเเรก</a></button>
      <button class="mt-2 btn btn-primary"><a class="text-white" href="/Crosswalk Agency/admin">ไปหน้า Admin</a></button>
    </div>
  </div>
