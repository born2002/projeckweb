<head>
  ...
  <link rel="stylesheet" href="./web/asset/css/cssfonten/project.css">
...
<section>
  ...
  <div class="text">
    <span class="Sales-order">โปรเจคทั้งหมด</span>
    <button class=" btn-Following" type="submit" data-toggle="modal" data-target="#myModal"> + เพิ่มข้อมูลโปรเจค</button>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group2">
          ...
          <div class="project">
            <input type="text" name="username" id="" class="project-1" placeholder="กรุณากรอชื่อลูกค้า">
          </div>
        </div>
        <div class="input-group3">
          ...
          <div class="project">
            ...
            <input type="email" name="email" id="email" class="project-1" placeholder="กรุณากรอกชื่อโปรเจค">
            <div class="">
              <span>ราคา</span>
            </div>
            <input type="number" name="number" id="number" class="project-2" placeholder="0.00">
          </div>
        </div>
      </div>
