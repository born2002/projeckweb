<head>
  ...
  <link rel="stylesheet" href="./web/asset/css/cssfonten/above.css">
...
<section>
  ...
  <div class="text">
    <span class="Sales-order">ใบสั่งขาย</span>
    <button class=" btn-Following" type="submit" data-toggle="modal" data-target="#myModal"><a class="sangbai" href="Sales-order-1.php">+ สร้างใบสั่งขาย</a></button>
        ...
        <form class="row w-100" id="searchContent">
          <div class="col-lg-3 mb-2">
            ...
            <select name="selecttype" id="selecttype" class="form-select">
              ...
              <option value="in-ship">รอตอบรับ</option>
              <option value="cancle">พ้นกำหนด</option>
              <option value="cancle">ยอมรับเเล้ว</option>
          ...
          <tr>
            ...
            <td>
              <div class="dt-layout-end">
                <div class="dt-paging">
                  <nav aria-label="pagination"><button class="dt-paging-button disabled previous" role="link" type="button" aria-controls="example" aria-disabled="true" aria-label="Previous" data-dt-idx="previous" tabindex="-1">‹</button><button class="dt-paging-button current" role="link" type="button" aria-controls="example" aria-current="page" data-dt-idx="0">1</button><button class="dt-paging-button next" role="link" type="button" aria-controls="example" aria-label="Next" data-dt-idx="next">2</button><button class="dt-paging-button next" role="link" type="button" aria-controls="example" aria-label="Next" data-dt-idx="next">›</button></nav>
                </div>
              </div>
            </td>
          </tr>
