...
<section>
  ...
  <div class="text">
    <span class="Sales-order">ใบเสนอราคา</span>
    <button class=" btn-Following" type="submit" data-toggle="modal" data-target="#myModal"><a class="sangbai" href="above1.php">+ สร้างใบเสนอราคา</a></button>
