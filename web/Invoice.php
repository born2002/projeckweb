<head>
  ...
  <link rel="stylesheet" href="./web/asset/css/cssfonten/Invoice.css">
...
<section>
  <div class="headbar">
    <span>ใบเเจ้งหนี้ </span>
  </div>
  <div class="text">
    <span class="Sales-order">ใบเเจ้งหนี้</span>
    <button class=" btn-Following" type="submit" data-toggle="modal" data-target="#myModal"><a class="sangbai" href="Invoice1.php">+ สร้างใบเเจ้งหนี้</a></button>
        ...
        <form class="row w-100" id="searchContent">
          <div class="col-lg-3 mb-2">
            ...
            <select name="selecttype" id="selecttype" class="form-select">
              ...
              <option value="cancle">เกินเวลาชำระ</option>
