<head>
  ...
  <link rel="stylesheet" href="./web/asset/css/cssfonten/paste-leaves.css">
...
<section>
  ...
  <div class="text">
    <span class="Sales-order">ใบวางบิล</span>
    <button class=" btn-Following" type="submit" data-toggle="modal" data-target="#myModal"><a class="baisrang" href="paste-leaves1.php">+ สร้างใบวางบิล</a></button>
